//
//  DeleteCustomerCardViewController.swift
//  square-integration
//
...
class DeleteCustomerCardViewController: UIViewController {

    @IBOutlet weak var textView: UITextView!
    @IBOutlet weak var responseView: UITextView!
    
     // MARK: - Send Http Body to endpoint
    @IBAction func requestDeleteCard(_ sender: UIButton) {
        ...
        let url: URL = URL(string: "http://localhost:3000/routes/deleteCustomerCard")!
