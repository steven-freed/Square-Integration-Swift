//
//  RetrieveCustomerViewController.swift
//  square-integration
//
...
class RetrieveCustomerViewController: UIViewController {

    @IBOutlet weak var textView: UITextView!
    @IBOutlet weak var responseView: UITextView!
    
    // MARK: - Send Http Body to endpoint
    @IBAction func requestCustomer(_ sender: UIButton) {
    ...
    let url: URL = URL(string: "http://localhost:3000/routes/retrieveCustomer")!
